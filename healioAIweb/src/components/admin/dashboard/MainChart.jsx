...
const MainChart = () => {
  ...
  // Customizing series to better match the visual style
  const v6Data = uData.map((val, i) => i > 10 ? val * 0.5 : val); // Taper off
  const v7Data = pData;
  const v8Data = pData.map(v => v > 300000 ? (v - 300000) * 1.5 : 0); // Only appear at end
      ...
      <Box sx={{ width: '100%', height: '100%' }}>
        <LineChart
          ...
          sx={{
            ...
            '.MuiAreaElement-series-v7': {
              fillOpacity: 0.3,
            },
            '.MuiAreaElement-series-v8': {
              fillOpacity: 0.3,
            },
          }}
