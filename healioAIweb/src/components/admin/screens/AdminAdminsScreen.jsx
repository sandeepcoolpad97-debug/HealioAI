...
import AdminViewDialog from '../admins/AdminViewDialog';
import AdminFormDialog from '../admins/AdminFormDialog';
import AdminDeleteDialog from '../admins/AdminDeleteDialog';
...
export default function AdminAdminsScreen() {
    ...
    const { list, meta, listLoading, error } = useSelector((state) => state.admins);
    ...
    useEffect(() => {
        dispatch(fetchAdmins({ page: page + 1, limit: pageSize }));
    ...
    const columns = [
        ...
        },
        {
            ...
            width: 180,
            valueGetter: (_, row) => formatDate(row.lastLoginAt),
        },
        {
            field: 'actions',
            headerName: 'Actions',
    ...
    return (
        <Box>
            ...
            <AdminViewDialog open={!!viewId} onClose={handleCloseView} />
            <AdminFormDialog
                open={createOpen}
            ...
            <AdminDeleteDialog
                open={!!deleteId}
                adminName={list.find((a) => a._id === deleteId)?.name}
