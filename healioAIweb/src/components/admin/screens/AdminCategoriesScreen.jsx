...
import CategoryViewDialog from '../categories/CategoryViewDialog';
...
export default function AdminCategoriesScreen() {
  ...
  const { list, meta, listLoading, error, selectedCategory } = useSelector((state) => state.categories);
  ...
  const { page, pageSize } = paginationModel;
    ...
    useEffect(() => {
      console.log('AdminCategoriesScreen list:', list);
      console.log('AdminCategoriesScreen meta:', meta);
    }, [list, meta]);

  useEffect(() => {
    dispatch(fetchCategories({ page: page + 1, limit: pageSize, search }));
