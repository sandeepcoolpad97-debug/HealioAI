...
export const WelcomeOne: React.FC<WelcomeOneProps> = ({navigation}) => {
  const {title, subtitle, ctaLabel} = onboardingStrings.welcomeOne;

  const handlePrimaryPress = () => {
    navigation.navigate(navigationRoutes.WelcomeTwo);
  };
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        <View style={styles.illustrationContainer}>
          <Image
            source={require('../../assets/images/wlimage1.png')}
